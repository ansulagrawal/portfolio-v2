...
import { email, leftTechStack, rightTechStack } from '@/data';
...
export const BentoGridItem = ({ className, id, title, description, img, imgClassName, titleClassName, spareImg }: BentoGridItemProps) => {
